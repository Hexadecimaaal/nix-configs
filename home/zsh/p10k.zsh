# Generated by Powerlevel10k configuration wizard on 2022-04-04 at 17:26 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_RUST_BACKGROUND=9
  ...
  typeset -g POWERLEVEL9K_RUST_VERSION_BACKGROUND=9
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_HASKELL_STACK_VISUAL_IDENTIFIER_EXPANSION='hs'
  ...
  function prompt_nix_drv() {
    if [ ${#nixenv_paths[@]} -ne 0 ]; then
      local installed=${(@k)nixenv_paths}
      p10k segment -t $installed
    fi
  }
  ...
  # User-defined prompt segments can be customized the same way as built-in segments.
  typeset -g POWERLEVEL9K_NIX_DRV_FOREGROUND=
  typeset -g POWERLEVEL9K_NIX_DRV_BACKGROUND=57
  typeset -g POWERLEVEL9K_NIX_DRV_VISUAL_IDENTIFIER_EXPANSION='nix'
